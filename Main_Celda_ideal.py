...
file_name = "file_name"  # cell to study
reports_dir = r"reports_dir"  # directory to save all results
temporal = r"temporal" # temporary directory to store and delete obsolete files
